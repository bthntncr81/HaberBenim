...
export class AppComponent {
  ...
  title = 'Haber Platform Admin';
  
  // All navigation items with required roles
  private allNavItems: NavItem[] = [
    { path: '/feed', label: 'Feed', icon: '📰', roles: ['Admin', 'Editor', 'SocialMedia'] },
    { path: '/approval', label: 'Approval', icon: '✅', roles: ['Admin', 'Editor', 'SocialMedia'] },
    { path: '/breaking', label: 'Breaking', icon: '🔴', roles: ['Admin', 'Editor'] },
    { path: '/publishing', label: 'Publishing', icon: '🚀', roles: ['Admin', 'Editor'] },
    { path: '/analytics', label: 'Analytics', icon: '📊', roles: ['Admin', 'Editor'] },
    { path: '/alerts', label: 'Alerts', icon: '🔔', roles: ['Admin', 'Editor'] },
    { path: '/reports', label: 'Reports', icon: '📋', roles: ['Admin'] },
    { path: '/audit', label: 'Audit', icon: '📜', roles: ['Admin'] },
    { path: '/sources', label: 'Sources', icon: '🔗', roles: ['Admin', 'Editor', 'SocialMedia'] },
    { path: '/rules', label: 'Rules', icon: '⚙️', roles: ['Admin'] },
    { path: '/integrations/x', label: 'X Integration', icon: '𝕏', roles: ['Admin'] }
  ];
