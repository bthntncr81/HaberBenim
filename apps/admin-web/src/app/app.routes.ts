...
export const routes: Routes = [
  ...
  { 
    path: 'publishing', 
    loadComponent: () => import('./pages/publishing/publishing.component').then(m => m.PublishingComponent),
    canActivate: [authGuard, roleGuard],
  ...
  { 
    path: 'breaking', 
    loadComponent: () => import('./pages/breaking/breaking.component').then(m => m.BreakingComponent),
    canActivate: [authGuard, roleGuard],
    data: { roles: ['Admin', 'Editor'] }
  },
  { 
  ...
  { 
    path: 'integrations/x', 
    loadComponent: () => import('./pages/x-integration/x-integration.component').then(m => m.XIntegrationComponent),
    canActivate: [authGuard, roleGuard],
    data: { roles: ['Admin'] }
  }
];
